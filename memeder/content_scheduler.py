...
def menu_update(message, bot):
    ...
    update2message = {
        ...
        'Show me males':        ('Ok, will show you only boys.', 'preferences', 3000),
        'Show me females':      ('Ok, will show you just girls.', 'preferences', 3001),
        'Show me all':          ('Will show you all users.', 'preferences', 3002),
        'Show me only memes':   ('Just memes,  good choice bro!', 'preferences', 3003),
        'Friends':              ('Your goals are set to `Friends`.', 'goals', 4000),
        'Relationships':        ('Good look to find you love;)', 'goals', 4001),
        'Unspecified':          ('Killing free time?)', 'goals', 4002),
        'Only memes':           ('Just memes, got it!', 'goals', 4003),
        'Upload bio':           ('Send me your bio:)', 'bio_update_flag', True),
        'Upload photo':         ('Send me your photo:)', 'photo_update_flag', True),
        'Clear bio':            ('Successfully deleted bio', 'use_bio', False),
        'Clear photo':          ('Successfully deleted photo', 'use_photo', False),
        'Male':                 ('Success!', 'sex', 5000),
        'Female':               ('Success!', 'sex', 5001),
    }
